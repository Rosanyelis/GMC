        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form class="" method="POST" action="{{ route('category.update', $data->id) }}">
                        @csrf
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="form-label" for="uname">Nombre de Categoria:</label>
                                <input type="text" class="form-control" name="name" id="uname"
                                    value="{{ $data->name }}" placeholder="Ejem: Carol Mendez">
                                @if ($errors->has('name'))
