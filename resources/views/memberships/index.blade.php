                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a href="{{ route('membership.edit', $item->id) }}" class="btn btn-sm btn-icon btn-warning"
                                        ...
                                        <form id="formDelete-{{ $item->id }}" action="{{ route('membership.destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
